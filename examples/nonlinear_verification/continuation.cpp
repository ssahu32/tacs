...
int main( int argc, char *argv[] ){
  ...
  TACSContinuation *cont = new TACSContinuation(assembler, 200, 50, 6, 1e-8, 1e3, 1e-3, 1e-30, 1e-8, 1e-30);
  cont->solve_tangent(mat, pc, ksm, f, 0, 0.001, ksm_print);
  ...
  f5->incref();
  f5->writeToFile("continuation.f5");
